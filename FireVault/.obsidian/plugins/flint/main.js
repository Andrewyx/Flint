...
async function uploadFile(files, index) {
  if (remoteVaultName !== "") {
    ...
    const remoteVaultRef = ref(vaultRef, `${remoteVaultName}`);
    const allLocalFiles = await this.app.vault.getMarkdownFiles();
    let allLocalFileNames = [];
