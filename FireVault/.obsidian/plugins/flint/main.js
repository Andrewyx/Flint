...
__export(main_exports, {
  FlintDataTransfer: () => FlintDataTransfer,
  default: () => FlintPlugin
});
...
async function deleteFile(remoteVaultFileList) {
...
async function clearRemoteVault(settings) {
...
async function forceUploadFiles(vault, settings) {
...
var FlintPlugin = class extends import_obsidian.Plugin {
  ...
  async setRemoteDesintation(remoteName) {
    ...
    new import_obsidian.Notice(`Syncing to ${remoteName}`);
...
var FlintSettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  async display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("Current Connected Remote Vault").setDesc("Active Firebase Vault").addDropdown((options) => options.addOptions(allVaultOptions).onChange(async (name4) => {
...
var ExampleView = class extends import_obsidian2.ItemView {
  constructor(leaf) {
    super(leaf);
  }
  getViewType() {
